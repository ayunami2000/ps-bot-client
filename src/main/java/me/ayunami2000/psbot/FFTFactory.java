...
/**
 * <p>Factory for FF{@link FFTTransform}s. Using the factory allows for sliding-in a faster, perhaps
...
public abstract class FFTFactory {
    ...
    /**
     * Creates a factory for FFT {@link FFTTransform} objects.
     *
     ...
     * @return FFT instance
     */
    public abstract FFTTransform create(int numberOfSamples);
    ...
    private static class JavaFFTFactory extends FFTFactory {
        ...
        @Override
        public synchronized FFTTransform create(final int numberOfSamples) {
     ...
     */
    public static class JavaFFT implements FFTTransform {
