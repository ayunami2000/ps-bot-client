...
import me.ayunami2000.psbot.AudioParser.Analysis.Klapuri;
import me.ayunami2000.psbot.AudioParser.Capture;
...
public class PitchDetection {
    ...
    public static int harmonics = 128;//20
    ...
    public void beginPitchDetection(){
        ...
        f0cands = new double[5*12*4];//5*12*4	//5 octaves, 12 half-steps per octave, quarter half-steps
